                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Butuh Bantuan? Klik di sini untuk informasi lebih lanjut.',
                  ...
                  return Card(
                    ...
                    child: Column(
                      ...
                      children: [
                        Expanded(
                          child: Image.network(
                            item.imageUrls[0], // Mengambil gambar pertama dari imageUrls
                            fit: BoxFit.cover,
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Stok: ${item.stock}',
                                style: TextStyle(color: const Color.fromARGB(255, 38, 96, 123)),
                              ),
                            ],
                          ),
                        ),
